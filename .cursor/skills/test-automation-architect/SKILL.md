...
At **session start**: read `memory/CONTEXT.md` + `memory/handoffs.md` (staff, explorer sections) + skim `memory/open-questions.md` for your open items.
...
- See [team-standards.md](../qa-team-orchestrator/team-standards.md) for tool choices, naming, CI stages, and flakiness policy.
