...
At **session start**: read `memory/CONTEXT.md` + `memory/handoffs.md` (pm, designer sections) + skim `memory/open-questions.md` for your open items.
...
- See [team-standards.md](../qa-team-orchestrator/team-standards.md) for severity definitions (P0–P3) used in risk flags.
