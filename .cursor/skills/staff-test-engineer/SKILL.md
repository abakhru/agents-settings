...
At **session start**: read `memory/CONTEXT.md` + `memory/handoffs.md` (pm, designer, explorer sections) + skim `memory/open-questions.md` for your open items.
...
- See [team-standards.md](../qa-team-orchestrator/team-standards.md) for tool choices per layer, naming conventions, severity definitions (P0–P3), CI stages, and flakiness policy.
